...
/**
 * Class for storing drink information
 */
public class DrinkInfo implements Consumable {

    private final int type = 2; // for loadjson
    private String name;
    private String notes;
    private double price;
    private double size; // printed as volume
     ...
     */
    public DrinkInfo (String name, String notes, double price,
    ...
    public String toString() {
        ...
        String stringVolume = String.format("%.2f", size);

        LocalDateTime today = LocalDateTime.now();
        long days = ChronoUnit.DAYS.between(this.expiryDate, LocalDateTime.now());

        if (days == 0) {
            return "<html> Name: " + name + "<br>" +
                    "Notes: " + notes + "<br>" +
                    "Price: " + stringPrice + "<br>" +
                    "Volume: " + stringVolume + "<br>" +
